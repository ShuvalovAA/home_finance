# Выпускная квалификационная работа "Разработка веб-приложения FinancePlanner"

Государственный университет "Дубна". Образовательное направление: 09.03.04 Программная инженерия

Автор: Шувалов Артемий Александрович, ПРОГ-С-20

Руководитель: старший преподаватель, Ушанкова Мария Юрьевна


## Краткое описание проекта

Веб-приложения FinancePlanner является прилоением SaaS. Оно закрывает потребности пользователей в управлении своими сбережениями,
