...
schema_view = get_schema_view(
    openapi.Info(
        title='Hfin API',
        default_version='v1',
        description='Open API for communication with Hfin APP.(c)shuvalovprodaction',
        terms_of_service='https://www.google.com/policies/terms/',
        contact=openapi.Contact(email='shuvalovartal@gmail.com'),
...
urlpatterns = [
    ...
    path('token/', include('common_utils.urls')),
